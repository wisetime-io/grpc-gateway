...
import (
	...
	gen "github.com/wisetime-io/grpc-gateway/protoc-gen-grpc-gateway/generator"
)
...
func New(reg *descriptor.Registry, useRequestContext bool, registerFuncSuffix, pathTypeString string, allowPatchFeature bool) gen.Generator {
	...
	for _, pkgpath := range []string{
		...
		"io",
		"net/http",
		"github.com/wisetime-io/grpc-gateway/runtime",
		"github.com/wisetime-io/grpc-gateway/utilities",
